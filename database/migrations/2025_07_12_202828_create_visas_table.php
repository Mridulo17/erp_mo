...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('visas', function (Blueprint $table) {
            ...
            $table->decimal('salary_bdt_amount', 25, 2);
            $table->integer('purchase_currency_id')->unsigned()->nullable();
            $table->foreign('purchase_currency_id')->references('id')->on('currencies')->onDelete('cascade');
            ...
            $table->integer('provide_food')->default(0);
            $table->integer('provide_accommodation')->default(0);
