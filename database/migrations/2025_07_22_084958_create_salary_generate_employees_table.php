...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('salary_generate_employees', function (Blueprint $table) {
            ...
            $table->decimal('employee_per_day_salary', 25, 2);
            $table->decimal('employee_net_salary', 25, 2);
            $table->decimal('employee_total_present_amount', 25, 2);
            $table->decimal('employee_weekend_days_amount', 25, 2);
            $table->decimal('employee_of_day_duty_bonus', 25, 2);
            $table->decimal('employee_holidays_amount', 25, 2);
            $table->decimal('employee_holidays_duty_bonus', 25, 2);
            $table->decimal('employee_festival_day_bonus', 25, 2);
            $table->decimal('employee_late_attendance_deduction', 25, 2);
            $table->decimal('employee_basic_salary', 25, 2);
            $table->decimal('employee_monthly_salary', 25, 2);
